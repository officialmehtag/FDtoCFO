...
const PILLARS = [
  ...
  'Investor & Capital Markets Mindset',
...
export default function FDtoCFO() {
  ...
  const openChat = (type: 'new' | 'pillar', pillarIdx?: number) => {
    ...
    const pillarOpeners: Record<number, string> = {
      0: 'When did you last explain something complex to a non-finance CEO in a way that actually changed their decision? That is where technical expertise matters at CFO level.',
      1: 'Think about the last strategic decision your company made. Were you part of shaping it, or did you find out after and then run the numbers?',
      2: 'How often does your finance team wait for month-end to get data? Real-time visibility is becoming a basic expectation at CFO level.',
      3: 'Of your direct reports right now, who is genuinely ready to take your seat if you moved up? Most FDs have not seriously thought about this.',
      4: 'When your MD or CEO is making a big decision, do they call you before they have made up their mind, or after?',
      5: 'When you present to the board, what do you lead with — the number or the story behind it? Most FDs lead with the number. CFOs lead with the business context.',
      6: 'Think about the last major initiative you signed off on. What was the downside scenario, and did anyone actually plan for it?',
      7: 'Outside of finance, which business leader in your company would go to bat for you if a CFO opportunity came up internally?',
      8: 'When a target is missed, are you the person who explains why, or the person who already flagged it was going to happen?',
      9: 'Has there been a moment in the last year where you knew something was not right but stayed quiet? Most people in finance have at least one.',
      10: 'If your CEO asked you right now what the three biggest trends reshaping your industry are, how confident are you in that answer?',
      11: 'Have you ever had a direct conversation with an investor or lender on behalf of the business? Not just preparing the deck. Actually in the room.',
      12: 'When was the last time you pushed for something new in your company that was not asked of you?',
      13: 'If you moved to a CFO role in a different country tomorrow, what would actually trip you up in the first three months?',
      14: 'Think about the worst month you had in this role. How did you show up on day one of that crisis?',
    }
    const opening = type === 'pillar' && pillarIdx !== undefined
      ? (pillarOpeners[pillarIdx] || 'What is actually happening at work right now?')
      : 'What is the most pressing thing happening at work right now?'
